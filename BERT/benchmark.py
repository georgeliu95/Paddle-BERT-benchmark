...
train_g.add_arg("num_train_steps",   int,    50, "Total steps to perform pretraining.") 
train_g.add_arg("warmup_steps",      int,    0,    "Total steps to perform warmup when pretraining.")
train_g.add_arg("save_steps",        int,    2,   "The steps interval to save checkpoints.")
...
#log_g.add_arg("cu_perf",             int,    0,     "Choose CuPy or libcudart.so")
...
data_g.add_arg("max_seq_len",         int,  128,                   "Tokens' number of the longest seqence allowed.")
data_g.add_arg("batch_size",          int,  18,
...
def train(args):
    ...
    while steps < args.num_train_steps:
        ...
        try:
            ...
            CD.nvtx.RangePush("Test: " + str(steps))
